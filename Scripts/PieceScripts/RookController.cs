...
public class RookController : MonoBehaviour, IPieceController
{
    public static RookController instance;
    List<Vector2> rookMoveList = new List<Vector2>();
    ...
    {
        rookMoveList.Clear();
        Direction((int)currentPosition.x, (int)currentPosition.y, 0, 1, color, rookMoveList);
        Direction((int)currentPosition.x, (int)currentPosition.y, 0, -1, color, rookMoveList);
        Direction((int)currentPosition.x, (int)currentPosition.y, -1, 0, color, rookMoveList);
        Direction((int)currentPosition.x, (int)currentPosition.y, 1, 0, color, rookMoveList);
        return rookMoveList;
    }
